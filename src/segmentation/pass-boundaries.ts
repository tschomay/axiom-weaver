...
const BOUNDARY_SYSTEM = `You are marking SCENE BOUNDARIES in a list of story events, given in the
order the story TELLS them — which is not necessarily the order they happen in. A flashback or a
vision is narrated where it sits in this list.
...
- Entering or leaving a flashback, a vision or a dream STARTS a new scene; staying inside one does
  not.
